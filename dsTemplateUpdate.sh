...
FILE_LIST=".gitignore bootstrap.sh bootstrap.ps1 mvnw mvnw.cmd project.toml skaffold.yaml src/main/resources/application-default.yml"
DIR_LIST=".github/workflows .mvn bindings etc helm k8s"
EXTRA_LIST="pom.xml"
