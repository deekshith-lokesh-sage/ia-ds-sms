...
aws ecr get-login-password --region us-west-2 | docker login --username AWS --password-stdin 827126933480.dkr.ecr.us-west-2.amazonaws.com/ia-ds-template
...
SKAFFOLD_OUTPUT_FILE=ia-ds-template.yml
